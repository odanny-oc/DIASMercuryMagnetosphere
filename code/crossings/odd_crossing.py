...
orbit_times = [(peak_times[i], peak_times[i+1]) for i in range(len(peak_data) - 1)]
...
odd_orbit_crossings = crossing_orbit_times[odd_crossings_mask]

bs_odd_orbit_crossings = crossing_orbit_times[bs_mp_orbit_crossings_mask[0]]

mp_odd_orbit_crossings = crossing_orbit_times[bs_mp_orbit_crossings_mask[-1]]
...
# These times broken?
times = ["2013-11-30 22:34", "2013-12-1 12:21"]
