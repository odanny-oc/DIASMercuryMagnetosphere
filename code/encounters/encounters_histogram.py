...
"""
Find number of encounters per orbit, searching orbit by orbit
"""

hollman_encounters_per_orbit = [encounter_finder(orbit) for orbit in orbit_data]

hollman_encounters_per_orbit = np.array(hollman_encounters_per_orbit, dtype=object)
print(sum([len(i) for i in hollman_encounters_per_orbit]))
...
hollman_encounters_per_orbit_alt = []
sun_encounters_per_orbit = []
phil_encounters_per_orbit = []

encounter_lists=[
        (hollman_encounters_per_orbit_alt, hollman_encounters_list, hollman_time_start, hollman_time_end),
...
encounters_per_orbit = [
        ("Hollman, per orbit search", hollman_encounters_per_orbit, hollman_encounters_data),
        ("Hollman", hollman_encounters_per_orbit_alt, hollman_encounters_list),
