...
delta_t_numeric = np.array(delta_t_numeric[1:])

delta_t_mask = (delta_t_numeric <= 7) & (delta_t_numeric >= 13)

print("Length of first and last orbit (partial)", delta_t_numeric[0], delta_t_numeric[-1])
...
print([(i[0].isoformat(), i[-1].isoformat()) for i in transition_orbit_times ])
